        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1.5fr_1fr] gap-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-purple-300 p-6 rounded-2xl h-[220px] lg:h-[270px] relative  overflow-hidden">
              <h3 className="text-[18px] md:text-[20px] lg:text-[22px] xl:text-[29px] font-bold text-gray-800 mb-3 gilroy-b">
              ...
              <img
                src={Invoice}
                className="w-[125px] lg:w-[150px] rotate-6 absolute -bottom-10 -right-3"
                alt=""
              />
            </div>
            ...
            <div className="bg-pink-200 p-6 rounded-2xl  h-[220px] lg:h-[320px] relative  overflow-hidden">
              ...
              <p className="text-[14px] xl:text-[15px] w-5/7  xl:w-3/5 gilroy-m">
                Send as many job requests as your quota allows. Whether they're
                big or small. Unlike per-job billing, small requests don't feel
                like a waste of money.
              </p>
              <img
                src={Task}
                className="w-[130px] lg:w-[170px] rotate-6 absolute -bottom-10 -right-3"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-orange-300 p-6 rounded-2xl h-[220px]  lg:h-[350px] relative  overflow-hidden flex flex-col justify-between items-start">
              <div>
                ...
                <img
                  src={Portal}
                  className="w-[125px] lg:w-[250px] rotate-6 absolute -bottom-10 -right-6"
                  alt=""
                />
              </div>
              <button className="flex gilroy-sb text-md text-white bg-black px-6 py-3 rounded-xl ">
            ...
            <div className="bg-green-200 p-6 rounded-2xl  h-[220px]  lg:h-[240px] relative  overflow-hidden">
              ...
              <img
                src={Money}
                className="w-[125px] lg:w-[150px] rotate-6 absolute -bottom-6 right-0"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-blue-200 p-6 rounded-2xl  h-[220px]  lg:h-[320px] relative  overflow-hidden">
              ...
              <img
                src={Rocket}
                className="w-[125px] lg:w-[170px] -rotate-6 absolute -bottom-6 -right-0"
                alt=""
              />
            </div>
            <div className="hidden lg:block bg-red-200 p-6 rounded-2xl  h-[220px]  lg:h-[270px] relative  overflow-hidden">
              ...
              <img
                src={Time}
                className="w-[125px] lg:w-[130px] rotate-6 absolute -bottom-3 -right-2"
                alt=""
              />
            </div>
          </div>
          ...
          <div className=" lg:hidden flex flex-col gap-4">
            <div className="bg-red-200 p-6 rounded-2xl  h-[220px]  lg:h-[270px]">
              <h3 className="text-[18px] md:text-[20px] lg:text-[22px] xl:text-[29px] font-bold text-gray-800 mb-3 gilroy-b">
                Eliminates Approval Delays
              </h3>
              <p className="text-[14px] xl:text-[15px] w-5/7  xl:w-3/5 gilroy-m">
