...
//         </p>
//         {/* <br /> Email us at{" "} */}
//         {/* <p className="gilroy-m text-center text-gray-700 text-md md:text-lg lg:text-xl mt-3 mb-20">
//           Email us at{" "}
//           <a
...
const pricingData = {
  "Vector Service": {
    ...
    weekly: {
      ...
      credits: "100 jobs per month",
      turnaround: "Turn around time 2 hours",
      link: "https://your-payment-link.com/vector-service-weekly",
      features: [
        "100 Jobs per Week",
        "Personal Artwork Portal Access",
        "Secure Storage",
    ...
    monthly: {
      ...
      credits: "500 Jobs per month",
      turnaround: "Turn around time 2 hours",
      link: "https://your-payment-link.com/vector-service-monthly",
      features: [
        "500 Jobs, 100 More than Weekly",
        "Personal Artwork Portal Access",
        "Secure Storage",
    ...
    budget: {
      ...
      credits: "200 job per month",
      turnaround: "Turn around time 2 hours",
      link: "https://your-payment-link.com/vector-service-budget",
      features: [
        "200 Jobs per Month",
        "Personal Artwork Portal Access",
        "Secure Storage",
  ...
  "Template Placement": {
    ...
    weekly: {
      ...
      credits: "125 job credits per month",
      turnaround: "Turn around time 1 hour",
      link: "https://your-payment-link.com/template-placement-weekly",
      features: [
        "125 Jobs per Week",
        "Personal Artwork Portal Access",
        "Secure Storage",
    ...
    monthly: {
      ...
      credits: "600 template placements per month",
      turnaround: "Turn around time 1 hour",
      link: "https://your-payment-link.com/template-placement-monthly",
      features: [
        "600 Jobs, 100 More than Weekly",
        "Personal Artwork Portal Access",
        "Secure Storage",
    ...
    budget: {
      ...
      credits: "300 Jobs per month",
      turnaround: "Turn around time 2 hours",
      link: "https://your-payment-link.com/template-placement-budget",
      features: [
        "300 Jobs per Month",
        "Personal Artwork Portal Access",
        "Secure Storage",
  ...
  "Production Ready Package": {
    ...
    weekly: {
      ...
      credits: "50 job credits per month",
      turnaround: "Turn around time 4 hours",
      link: "https://your-payment-link.com/production-package-weekly",
      features: [
        "50 Jobs per Week",
        "Personal Artwork Portal Access",
        "Secure Storage",
    ...
    monthly: {
      ...
      credits: "150 production packages per month",
      turnaround: "Turn around time 4 hours",
      link: "https://your-payment-link.com/production-package-monthly",
      features: [
        "300 Jobs, 100 More than Weekly",
        "Personal artwork Portal Access",
        "Secure Storage",
    ...
    budget: {
      ...
      credits: "150 Jobs per month",
      turnaround: "Turn around time 2 hours",
      link: "https://your-payment-link.com/production-package-budget",
      features: [
        "150 Jobs per Month",
        "Personal Artwork Portal Access",
        "Secure Storage",
