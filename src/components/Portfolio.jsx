...
const Portfolio = () => {
  return (
    <section className="mt-30 px-4.5 md:px-10 xl:px-15">
      <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-11 md:grid-rows-2 gap-2 h-auto md:h-[130vh] container mx-auto mt-10">
