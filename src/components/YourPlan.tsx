...
const YourPlan = () => {
  return (
    <section id="yourPlan" aria-labelledby="yourplan-heading">
      <div className="mt-15 md:mt-20 lg:mt-30 px-4.5 md:px-10 xl:px-15">
        ...
        <div className="container w-full mx-auto mt-10">
          <div className="flex flex-col md:flex-row gap-4" role="list">
            <article
              data-aos="fade-up"
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div
                  ...
                  aria-hidden="true"
                >
                  <span className="gilroy-b text-[20px] md:text-[22px] xl:text-[27px] text-white w-fit">
                    1
                  </span>
                </div>
            ...
            >
              <div className="flex lg:justify-center justify-start items-center lg:items-start gap-3 mb-3">
                <div
                  className="rounded-full bg-black min-w-10 h-10 flex items-center justify-center mt-0.5"
                  aria-hidden="true"
                >
                  <span className="gilroy-b text-[20px] md:text-[22px] xl:text-[27px] text-white w-fit">
                    2
