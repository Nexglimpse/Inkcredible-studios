      ...
      <div className="px-4.5 md:px-10 xl:px-15 lg:flex justify-start">
        <div className="lg:w-1/2 ">
          ...
          <p className="text-justify md:text-center lg:text-start text-md md:text-lg xl:text-[20px] mt-3 gilroy-m leading-snug text-black">
            ...
            more—often delivering in just 1 hour. As PPAI and ASI members, we
            know your industry’s pace. With transparent pricing, personalized
            service, and a secure portal, we ensure reliability without hidden
            costs or headaches.
          </p>
